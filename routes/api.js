...
router.get("/download/youtube", async (req, res, next) => {
    ...
    if (listkey.includes(apikey)) {
        const json = await ytdl(url, type);
        res.json(json);
    } else {
        res.json(loghandler.apikey);
    }
...
router.get("/news/tempo", async (req, res, next) => {
    ...
    if (listkey.includes(apikey)) {
        fetch(
            encodeURI(`https://news-api-zhirrr.vercel.app/v1/tempo-news/${url}`)
        )
            .then(response => response.json())
            .then(data => {
                var result = data;
...
router.get("/news/antara", async (req, res, next) => {
    ...
    if (listkey.includes(apikey)) {
        fetch(
            encodeURI(
                `https://news-api-zhirrr.vercel.app/v1/antara-news/${url}`
            )
        )
            .then(response => response.json())
            .then(data => {
...
router.get("/other/github-stalk", async (req, res, next) => {
    ...
    if (listkey.includes(apikey)) {
        fetch(
            encodeURI(
                `https://github-api-zhirrr.vercel.app/api/detailuser?q=${text}`
            )
        )
            .then(response => response.json())
            .then(data => {
...
router.get("/other/hilih", async (req, res, next) => {
    ...
    if (listkey.includes(apikey)) {
        fetch(
            encodeURI(
                `https://hilih-api-zhirrr.vercel.app/api/hilih?kata=${text}`
            )
        )
            .then(response => response.json())
            .then(data => {
...
router.get("/other/kbbi", async (req, res, next) => {
    ...
    if (listkey.includes(apikey)) {
        fetch(
            encodeURI(
                `https://kbbi-api-zhirrr.vercel.app/api/kbbi?text=${text}`
            )
        )
            .then(response => response.json())
            .then(data => {
